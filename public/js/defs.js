...
(function (root) {
  ...
  D.ERAS = [
    { id: 'stone',      th: 'ยุคหิน',          lv: 1,  icon: '🪨', desc: 'เก็บไม้ หิน ทำเครื่องมือหิน สร้างเพิงไม้ ปลูกผัก และต่อแพข้ามน้ำ' },
    { id: 'iron',       th: 'ยุคสำริด-เหล็ก',   lv: 5,  icon: '⚒️', desc: 'เครื่องมือเหล็ก (ตัด/ขุดเร็ว 2 เท่า) ผนังหิน หน้าต่าง ชั้นหนังสือ เรือพาย' },
    { id: 'medieval',   th: 'ยุคกลาง',         lv: 10, icon: '🏰', desc: 'ขี่ม้า ผนังอิฐ พรม โคมไฟ เตาทำอาหาร โซฟา น้ำพุ' },
    { id: 'industrial', th: 'ยุคอุตสาหกรรม',    lv: 15, icon: '🏭', desc: 'จักรยาน ไฟถนน อ่างอาบน้ำ ชักโครก ตู้เย็น มอเตอร์ไซค์' },
    { id: 'modern',     th: 'ยุคปัจจุบัน',       lv: 20, icon: '🏙️', desc: 'รถยนต์ ทีวี คอมพิวเตอร์ เรือเร็ว และเฮลิคอปเตอร์บินข้ามทุกสิ่ง' },
  ];
